...
export const SplitTextButton: React.FC<SplitTextButtonProps> = ({
  ...
  return (
    <Component
      ...
      className={`group relative inline-flex items-center justify-between gap-2 sm:gap-3 px-3 sm:px-4 lg:px-5 py-2 sm:py-2.5 rounded-full font-sans text-[11px] sm:text-xs lg:text-sm font-bold tracking-wide uppercase transition-all duration-300 border shadow-md hover:shadow-lg active:scale-95 whitespace-nowrap shrink-0 ${getThemeStyles()} ${className}`}
    >
