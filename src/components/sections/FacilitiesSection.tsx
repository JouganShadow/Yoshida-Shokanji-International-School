  ...
  const facilities: FacilityItem[] = [
    {
      ...
      coaches: 'Direct Japanese Certified Coaches',
      description: 'Our world-renowned, wood-floored training dojo dedicated to cultivating physical resilience, reflex speed, and moral character in Japanese Shotokan Karate.',
    ...
    },
    {
      ...
      capacity: '6 Lanes, Full Team',
      coaches: 'Professional Lifeguards & Coaches',
    ...
    {
      id: 'labs',
      name: 'Advanced Physics, Chemistry & ICT Labs',
      ...
      coaches: 'Specialized Lab Technicians',
      description: 'Fully equipped practical workstations tailored for Cambridge IGCSE and Advanced Level experiments. Includes advanced microscope setups and dedicated programming rigs.',
      features: ['High-speed internet workstations', 'Certified chemical storage cabinets', 'Individual experiment apparatus'],
    },
    {
      id: 'library',
      name: 'Heritage Library & Language Sanctuary',
      type: 'Research & Study',
      ...
      description: 'A tranquil reading environment holding extensive Cambridge reference guides, classical English literature, and direct Japanese language learning archives.',
      features: ['Dedicated silent study booths', 'Digital catalog access tablets', 'Comfortable reading lounge chairs'],
    },
  ];
