...
export const MANAGEMENT_MEMBERS: ManagementMember[] = [
  {
    id: 'chairman',
    name: 'Most Ven. Banagala Upatissa Nayaka Thero',
    role: 'Chairman & Founder',
    bio: 'Founder and Chairman of Yoshida Shokanji International School and the Yoshida Educational and Social Service Foundation (est. 1979). Chief Sangha Nayake of Japan and Chairman of the Mahabodhi Society of Sri Lanka. Dedicated to providing English medium education while preserving Sri Lankan cultural heritage and Japanese discipline.',
    imageUrl: 'https://yoshida.edu.lk/assets/img/team/5.png',
    quote: 'The purpose of establishing Yoshida Shokanji International School in the year 2000 was to provide an opportunity for children to receive an education in the English Medium in a conducive atmosphere consistent with modern educational trends, while preserving Sri Lankan traditional values and cultural heritage.',
  ...
  {
    id: 'chief-advisor',
    name: 'Brigadier Udaya Ariyaratne',
    role: 'Chief Advisor & Academic Director',
    bio: 'Chief Advisor to the Management, guiding student leadership, campus safety protocols, character development, and strategic institutional governance.',
